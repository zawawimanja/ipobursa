// Update MITI countdown data for active MITI allocations (from SahamOnline portal, 18-Aug-2026)
const fs = require('fs');
...
// 1. Big Caring Group — portal: 922.73M tawaran, 611 pemohon, tutup 6 hari lagi (18-Aug -> 24-Aug)
const big = data.find(x => x.id === 'big-caring-group-bhd');
if (big) {
    big.mitiCloseDate = '24-Aug-2026';
    big.mitiOfferShares = 922730000;
    big.mitiApplicants = 611;
...
// 2. IOIPG Malaysia REIT — portal: 687.5M tawaran, 78 pemohon, tutup 9 hari lagi (18-Aug -> 27-Aug)
const io = data.find(x => x.id === 'ioipg-malaysia-reit');
if (io) {
    io.mitiCloseDate = '27-Aug-2026';
    io.mitiOfferShares = 687500000;
    io.mitiApplicants = 78;
