...
// ---------------------------------------------------------
// SECTION 1: MORNING ATH BREAKOUT SCAN
// ---------------------------------------------------------
console.log('========================================================================');
...
// ---------------------------------------------------------
// SECTION 2: EVENING SWING & SCALP SCANNER
// ---------------------------------------------------------
console.log('========================================================================');
console.log('📈 ACTIVE SWING & SCALP PORTFOLIO WATCHLIST (EVENING BRIEF)');
console.log('========================================================================');
...
console.log('--- SWING PICKS WATCHLIST ---');
swingPicks.forEach(p => {
    console.log(`SWING | ${p.symbol.padEnd(8)} | ${p.companyName.padEnd(30)} | Gred ${p.grade} | RM ${p.currentPrice.toFixed(3)} | TP: RM ${p.sifuTP.toFixed(2)} | Upside: ${(p.upside + '%').padEnd(6)} | ${p.trend}`);
});

console.log('\n--- SCALP PICKS WATCHLIST ---');
scalpPicks.forEach(p => {
    console.log(`SCALP | ${p.symbol.padEnd(8)} | ${p.companyName.padEnd(30)} | Gred ${p.grade} | RM ${p.currentPrice.toFixed(3)} | TP: RM ${p.sifuTP.toFixed(2)} | Upside: ${(p.upside + '%').padEnd(6)} | ${p.trend}`);
});
console.log('========================================================================\n');
