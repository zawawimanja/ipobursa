const IPO_DATA = [
  ...
  },
  {
    ...
    "predictedGrade": "B",
    "analystInsight": "✅ <b>WORTH IT (GRADE B — MITI ACTIVE OPEN)</b><br>Rangkaian runcit farmasi terbesar di Malaysia hasil penggabungan jenama BIG Pharmacy dan CARiNG Pharmacy.<br><br>📊 <b>Status Permohonan MITI:</b><br>• Saham Khas Bumiputera (SKB) KINI DIBUKA untuk permohonan di portal SahamOnline MITI (Tutup 23 Ogos 2026).<br>• <b>Harga Indikatif:</b> Akan Dimaklumkan Kemudian (TBA).<br>• <b>Bank Penasihat:</b> Maybank IB, RHB IB, AmInvestment Bank.<br>• Memiliki gandaan PE yang munasabah dengan margin runcit stabil & sektor defensif kalis kemelesetan.",
    "sifuTargetPrice": 0,
