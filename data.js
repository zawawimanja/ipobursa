const IPO_DATA = [
  {
    ...
    "targetPe": 20,
    "catalysts": [
      "<strong>Sektor Semikonduktor & Cleanroom:</strong> Rekod pertumbuhan kukuh dalam Ultra-High Purity (UHP) precision fabrication dan abatement systems di bawah tajaan IB cemerlang M&A Securities.",
      "<strong>Valuation Menarik (implied PE 16.7x):</strong> Pada harga IPO RM0.27, didagangkan di bawah purata peers teknologi (20x-25x PE).",
      "<strong>Wow Factor:</strong> Margin PAT berkembang kukuh kepada 13.2% hasil daripada permintaan global yang meningkat."
    ],
    "peers": "<strong>Peer Comparison:</strong> Peers didagangkan pada 20x - 25x PE. EcoSys mempunyai kelebihan margin pemulihan sektor semikonduktor."
  },
  {
    "id": "srkk-ai",
